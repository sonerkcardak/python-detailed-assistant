...
class Features:
    ...
    def mapfeature(self, data):
        ...
        driver = webdriver.Chrome(
            'C:/Users/cmd/Desktop/chromedriver.exe')  # Optional argument, if not specified will search path.
    ...
    def playyoutube(self, data):
        ...
        if 'youtube' in data:
            ...
            self.mediamodule.speak("Bunu Söylediniz:" + domain + "?") 
    ...
    def stopsong(self, data):
        print("devre dışı bıraktın soner ana koda ekledin")
    ...
    def news(self, data):
        ...
        for i in range(0, len(basliklar)):
            ...
            time.sleep(15)
    def yapank(self, data):
        self.mediamodule.speak("Beni Oluşturan kişi Soner Çardaktır.Ben Python+jamper+C plas plas + rasspery + tansflow kodlaması ile oluştum.")
        print("Beni Oluşturan kişi Soner Çardaktır.Ben AI")
        time.sleep(1)

    def arama2(self, data):
        print("Google'de ne aramamı istiyorsun?")
        self.mediamodule.speak("Google'de ne aramamı istiyorsun?")
        time.sleep(1)
        try:
            data3 = self.mediamodule.recordAudio()
            self.mediamodule.speak("Bunu Söylediniz:" + data3 + "?") 
            url = "https://www.google.com/search?q=" + data3
